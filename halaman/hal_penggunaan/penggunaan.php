<script type="text/javascript" src="halaman/hal_penggunaan/jquery.js"></script>
<script language="javascript">
  $(document).ready(function() {
    $('#id_prodi').change(function() {
      ...
      $.ajax({
        type: 'GET',
        url: 'halaman/hal_penggunaan/select-for-ajax.php',
...
// Apabila perbaikan sudah login dengan benar, maka terbentuklah session
  ...
  $aksi = "halaman/hal_penggunaan/aksi_penggunaan_approval.php";
      ...
      echo "<div class='row'>
            <div class='col-xs-12'>
              <div class='widget-box'>
                ...
                <div class='widget-body'>
                  <div class='widget-main'>
                    <form method='POST' action='$aksi?halamane=penggunaan&act=input2'>
                      <div>
