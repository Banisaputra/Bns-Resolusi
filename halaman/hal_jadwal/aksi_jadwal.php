...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  if ($halamane=='jadwal' AND $act=='input'){
    ...
    $input = "INSERT INTO perawatan(id_jadwal,tgl,id_prodi,id_mesin,point_chek,tgl_jadwal) VALUES('$id_jadwal','$tgl','$id_prodi','$id_mesin','$point_chek','$tgl_jadwal')";
  ...
  elseif ($halamane=='jadwal' AND $act=='update'){
    ...
    $point_chek = trim(htmlspecialchars($_POST['point_chek']));
    $tgl_jadwal = trim(htmlspecialchars($_POST['tgl_jadwal']));
    $update = "UPDATE perawatan SET tgl='$tgl',id_prodi='$id_prodi',id_mesin='$id_mesin',point_chek='$point_chek',tgl_jadwal='$tgl_jadwal' WHERE id_jadwal = '$id_jadwal'";
