      ...
      echo " <div class='row'>
                  <div class='col-xs-12'>
                    ...
                    <div class='table-header'>
                      Tabel perbaikan Non Rutin View
                    </div>
                    <div>";
      if($_SESSION['leveluser']== 'superAdm'){
        $query  = "SELECT * FROM perbaikan a inner join user b using(id_user) inner join mesin c using(id_mesin)";
      }else{
        $query  = "SELECT * FROM perbaikan a inner join user b using(id_user) inner join mesin c using(id_mesin) WHERE a.id_prodi ='$id_prodi'";
      }
