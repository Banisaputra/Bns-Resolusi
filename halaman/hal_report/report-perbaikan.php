      ...
      Highcharts.chart('blokgraf1', {
        ...
        series: [{
          ...
          data: [
            ...
            <?php
            $data = mysqli_query($konek, "SELECT id_mesin AS mesin,count(*) AS jumlah FROM perbaikan WHERE tgl_buat BETWEEN '$_POST[dari]' AND '$_POST[sampai]' GROUP BY id_mesin ORDER BY id_mesin");
